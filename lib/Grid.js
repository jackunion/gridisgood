        ...
        if (this.state.action) {
            ...
            if (this.state.action === 'resizing') {
                ...
                this.updateState({
                    'placeholder': {
                        'children': this.state.placeholder.children,
                        'width': Math.max(this.props.baseWidth, e.pageX - this.refs.Grid.offsetLeft - this.state.placeholder.left),
                        'height': Math.max(this.props.baseHeight, e.pageY- this.refs.Grid.offsetTop - this.state.placeholder.top),
            ...
            layout.unshift(layout.splice(layout.indexOf(block), 1)[0]);
